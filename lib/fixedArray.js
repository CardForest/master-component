...
FixedArray.prototype.$serialize = function () {
  var res = [];
  for (var i = 0; i < this.$config.$length; i++) {
    var serialized = this.$$serializeProperty(i, this.$config.$elem);
    if (serialized == null) {
...
Object.defineProperty(FixedArray.prototype, '$serialize', {enumerable: false});
