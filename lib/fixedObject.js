...
FixedObject.prototype.$serialize = function () {
  var res = {};
  var self = this;
  Object.keys(this.$config.$schema).forEach(function (propertyKey) {
    var serialized = self.$$serializeProperty(propertyKey, self.$config.$schema[propertyKey]);
    if (serialized != null) {
...
Object.defineProperty(FixedObject.prototype, '$serialize', {enumerable: false});
